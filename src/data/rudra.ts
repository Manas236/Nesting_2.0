...
/* ---------- Gallery — real on-site photographs ----------
   ...
   `node scripts/optimise-project-images.mjs rudra`, which reads
   scripts/alt-text/rudra.tsv. Edit the alt text there, not here, or the
   next run overwrites it. Files live under public/images/projects/rudra/
...
export const gallery: { src: string; alt: string; category: string; width?: number; height?: number }[] = [
  { src: "/images/projects/rudra/photos/rudra-exterior-01.webp", alt: "Climbing plants up the front of the finished building, green balcony panels and shuttered shops below — Rudra, Karanjade", category: "Exterior", width: 1066, height: 1600 },
  { src: "/images/projects/rudra/photos/rudra-exterior-02.webp", alt: "The building along the street with its neighbours, shops at pavement level and cars parked nose-in — Rudra, Karanjade", category: "Exterior", width: 1600, height: 1200 },
  { src: "/images/projects/rudra/photos/rudra-exterior-03.webp", alt: "Looking up the elevation into the sun, climbers on the balconies and the shutters closed below — Rudra, Karanjade", category: "Exterior", width: 1200, height: 1600 },
  { src: "/images/projects/rudra/photos/rudra-aerial-view-01.webp", alt: "The wooded knoll above the road, traffic running along its foot below the street lights — Rudra, Karanjade", category: "Aerial view", width: 1600, height: 1066 },
  { src: "/images/projects/rudra/photos/rudra-aerial-view-02.webp", alt: "Blue-tarped stalls and parked vehicles on the road below, the cliff-topped hill across the skyline — Rudra, Karanjade", category: "Aerial view", width: 1600, height: 1066 },
  { src: "/images/projects/rudra/photos/rudra-aerial-view-03.webp", alt: "The flyover curving under the quarried cliff face, retaining walls and the rail line beneath it — Rudra, Karanjade", category: "Aerial view", width: 1600, height: 1066 },
  { src: "/images/projects/rudra/photos/rudra-aerial-view-04.webp", alt: "A broad road lined with apartment blocks, open plots to either side and the hills behind — Rudra, Karanjade", category: "Aerial view", width: 1600, height: 1066 },
  { src: "/images/projects/rudra/photos/rudra-aerial-view-05.webp", alt: "Cars and motorcycles packed onto the open ground beside the underpass retaining wall — Rudra, Karanjade", category: "Aerial view", width: 1600, height: 1200 },
  { src: "/images/projects/rudra/photos/rudra-entrance-01.webp", alt: "Green-marble floor, notice board and a small shrine shelf in the entrance lobby — Rudra, Karanjade", category: "Entrance", width: 1600, height: 1200 },
  { src: "/images/projects/rudra/photos/rudra-entrance-02.webp", alt: "Lift doors and the dark marble staircase side by side at the entrance, railing rising past — Rudra, Karanjade", category: "Entrance", width: 1600, height: 1200 },
  { src: "/images/projects/rudra/photos/rudra-corridor-01.webp", alt: "A garlanded flat door off the tiled landing, the staircase and its steel railing alongside — Rudra", category: "Corridor", width: 1600, height: 1200 },
  { src: "/images/projects/rudra/photos/rudra-corridor-02.webp", alt: "Green-marble steps and a steel railing climbing past a grilled window on a typical floor — Rudra", category: "Corridor", width: 1600, height: 1200 },
  { src: "/images/projects/rudra/photos/rudra-lift-01.webp", alt: "Stainless-steel lift door beside the staircase, under the lobby's brass pendant light — Rudra", category: "Lift", width: 1600, height: 1066 },
  { src: "/images/projects/rudra/photos/rudra-parking-01.webp", alt: "A van and motorcycles on the red and yellow checkered floor of the stilt parking — Rudra", category: "Parking", width: 1600, height: 1200 },
  { src: "/images/projects/rudra/photos/rudra-parking-02.webp", alt: "Motorcycles lined up between the columns of the stilt parking, seen in from the driveway — Rudra", category: "Parking", width: 1600, height: 1200 },
  { src: "/images/projects/rudra/photos/rudra-rooftop-01.webp", alt: "Bare concrete floor and columns on the covered rooftop level, roofing sheets stacked by the parapet — Rudra, Karanjade", category: "Rooftop", width: 1400, height: 1050 },
  { src: "/images/projects/rudra/photos/rudra-rooftop-02.webp", alt: "Blue metal canopies and a steel stair rail on the open rooftop, parapets on every side — Rudra, Karanjade", category: "Rooftop", width: 1600, height: 1200 },
];
